    ...
    <section className="w-full bg-[#0B0B12] pt-[100px]">
      ...
      >
        ...
        >
          ...
          <div>
            <h3 className="text-[32px] font-semibold text-white mb-[20px] max-[1024px]:text-[28px] max-[640px]:text-[22px]">
              What is BAD NFT?
            </h3>
            <ul className="text-[18px] text-gray-300 leading-[1.8] list-disc pl-[22px] max-[1024px]:text-[16px] max-[640px]:text-[15px]">
              <li>
      ...
      >
        ...
        <div className="w-[50px] h-[50px] bg-[#E5f066] rounded-full flex items-center justify-center absolute -top-[25px] shadow-md">
